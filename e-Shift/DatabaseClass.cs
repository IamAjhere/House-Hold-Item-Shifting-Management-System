...
namespace e_Shift
{/// <summary>
/// This class is created to access globaly throughout the application. This class has methods to;
///     1.create connection
///     2.close connection
///     3.Read Data from database with DataAdapter
///     4.Read Data from database with Data Reader
///     5.Run custom query with sqlcommand.
///     6.Execute the query and display it in Data Grid View
///     
/// </summary>
    class DatabaseClass
    {
        ...
        private static string strConnString = "Data Source=(local);Initial Catalog=eshift;Integrated Security=True";
